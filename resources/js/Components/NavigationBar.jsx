			...
			<div className="bg-yellow-500 pt-2 pl-20 pr-20">
				<nav className="relative px-4 py-4 flex justify-between items-center ">
					...
					<ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
						<li><a className="text-xl text-black hover:text-gray-500" href="#">Beranda</a></li>
						<li className="text-gray-300">
							
						</li>
						<li><a className="text-xl text-black hover:text-gray-500" href="#">Tentang GAS</a></li>
						<li className="text-gray-300">
							
						</li>
						<li><a className="text-xl text-black hover:text-gray-500" href="#">Fitur</a></li>
						<li className="text-gray-300">
							
						</li>
						<li><a className="text-xl text-black hover:text-gray-500" href="#">Daftar</a></li>
						<li className="text-gray-300">
						
						</li>
						<li><a className="text-xl text-black hover:text-gray-500" href="#">Karir</a></li>
					</ul>
					...
					<a className="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-2xl transition duration-200" href="#">
